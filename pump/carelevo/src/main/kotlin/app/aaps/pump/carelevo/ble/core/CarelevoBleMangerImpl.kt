package app.aaps.pump.carelevo.ble.core
...
import app.aaps.pump.carelevo.ble.data.FailureState
...
import app.aaps.pump.carelevo.ble.ext.existBondedDevice
import app.aaps.pump.carelevo.ble.ext.findCharacteristic
import app.aaps.pump.carelevo.ble.ext.hasPermission
import app.aaps.pump.carelevo.ble.ext.isEnabled
import app.aaps.pump.carelevo.ble.ext.isWritable
import app.aaps.pump.carelevo.ble.ext.isWritableWithoutResponse
import app.aaps.pump.carelevo.ble.ext.refresh
import app.aaps.pump.carelevo.ble.ext.removeBond
...
class CarelevoBleMangerImpl @Inject constructor(
    ...
    private fun isConnected(macAddress: String): Boolean {
        ...
        CarelevoBleSource.bluetoothState.value ?: return false
